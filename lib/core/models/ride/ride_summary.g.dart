...
RideSummary _$RideSummaryFromJson(Map<String, dynamic> json) => RideSummary(
  ...
  departureDateTime: RideSummary._dateTimeFromJson(
    RideSummary._readDateTimeFields(json, 'departureDateTime') as String,
  ),
...
Booking _$BookingFromJson(Map<String, dynamic> json) =>
    Booking(id: (json['id'] as num).toInt(), status: json['status'] as String);
