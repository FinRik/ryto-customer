...
class TripInfo {
  ...
  const TripInfo({required this.title, required this.value,this.isAmount = false, this.alignment});
}
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(width: 1, color: Color(0xff222328)),
      ),
      child: Column(
