...
class _AvailableTripsScreenState extends State<AvailableTripsScreen> {
          ...
          builder: (context, state) {
            return Column(
              ...
              children: [
                ...
                // Route Header Card - Stays static regardless of loading state
                Container(
  ...
  Widget _buildBody(TripSetupState state) {
              ...
              itemBuilder: (context, index) {
                ...
                return TripListItem(
                  ...
                  onTap: () {
                    ...
                    context.push(Paths.BOOKATRIP, extra: trip);
                  },
                );
              },
            ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                ScButton(btnText: "Notify me when available", onClick: () {}),
              ],
            ),
          ),
        ],
